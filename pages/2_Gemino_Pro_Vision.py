...
st.set_page_config(
    page_title="Chat To AI",
    page_icon="🤖",
    menu_items={
        'About': "# Made by Arish Arsalan"
    }
)

st.title('Upload Image And Ask Anything About it')

if "app_key" not in st.session_state:
    app_key = st.text_input("Your Gemini Api Key", type='password')
    if app_key:
...
if "app_key" in st.session_state:
    if prompt := st.chat_input("ask about this picture"):
        if image is None:
